...
class RunTimeParameters:
    def __init__(self):
        ...
        self.starModelPath    = os.path.join(os.getcwd(), 'StarModels')
        ...
        """
        self.mesaRun      = True        # Run With MESA?
        self.mesaMode     = 0           # 0: legacy ./rn workflow, 1: pyMesa star_evolve_step workflow
        ...
        self.orbitIntegrator = 'circular' # circular / two_body explicit Euler
        ...
        self.pyMesaMainSrcPath = os.path.abspath(os.path.join(os.getcwd(), '..', 'pyMesaMain', 'src'))
        self.pyMesaStepMaxSteps = 400
        self.saveDataPath     = '..'
