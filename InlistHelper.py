...
# Resets inlist star age to match star mod file [used for fresh runs]
def setInitialInlistAge(runParameters, simParameters, modData):
    starAge = getstarAge(modData)
...
def initializeMesaInlist(runParameters, simParameters, modData):
    ...
    setInitialInlistAge(runParameters, simParameters, modData)
