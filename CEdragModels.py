...
def getAcc2019Drag(m,rho,v,q,Ma,gam, Rs_Ra, fit=False):
    ...
    Ma: Mach Number
    """
    dMHL = CEphysics.getMdotHL(m, rho, v)
    FdHL = CEphysics.getFdHL(m, rho, v)
...
def getNS2015Drag(m,rho,v,Rs,ep,fit=False):
    ...
    mdotHL      = CEphysics.getMdotHL(m,rho,v)
...
def getHybirdDrag(m2, Ma,rho, v, a, Ra, cs, rmin, dt, epGrad):
    ...
    if(Ma > 1.1):
        ...
        dM = CEphysics.getMdotHL(m2, rho, v)
    return dM, Fd
